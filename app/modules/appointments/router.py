...
def get_appointments(
    ...
    return service.get_appointments(skip, limit, patient_id, doctor_id, status, date_from, date_to)
...
def get_upcoming_appointments(
    ...
    service = AppointmentsService(db)
    return service.get_upcoming_appointments(doctor_id, limit)
...
def update_appointment(
    ...
    service = AppointmentsService(db)
    return service.update_appointment(appointment_id, appointment_data)
...
def complete_appointment(
    ...
    service = AppointmentsService(db)
    return service.complete_appointment(appointment_id)
