...
async def create_visit(
    ...
    return await service.create_visit(visit_data, current_user.id)
...
async def get_visits(
    ...
    service = VisitsService(db)
    visits = await service.get_visits(skip, limit, patient_id, doctor_id, status)
...
async def get_upcoming_visits(
    ...
    service = VisitsService(db)
    visits = await service.get_upcoming_visits(doctor_id, limit)
...
async def update_visit(
    ...
    return await service.update_visit(visit_id, visit_data)
...
async def add_diagnosis(
    ...
    return await service.add_diagnosis(visit_id, diagnosis_data)
...
async def get_visit_diagnoses(
    ...
    return await service.repository.get_diagnoses_by_visit(visit_id)
...
async def add_treatment(
    ...
    return await service.add_treatment(visit_id, treatment_data)
...
async def get_visit_treatments(
    ...
    return await service.repository.get_treatments_by_visit(visit_id)
...
async def update_vital_signs(
    ...
    return await service.update_vital_signs(visit_id, vital_signs_data)


@router.get("/{visit_id}/vital-signs", response_model=Optional[VitalSigns])
async def get_visit_vital_signs(
    visit_id: int,
    db: AsyncSession = Depends(get_db),
    current_user: dict = Depends(get_current_user)
):
    ...
    return await service.repository.get_vital_signs_by_visit(visit_id)
